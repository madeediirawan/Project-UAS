    ...
    case 'save':
        if($_SERVER['REQUEST_METHOD']=="POST"){
            ...
            if(empty($_POST['merek'])){
                $err['merek']="merek Produk Wajib Terisi";
            }
            ...
            if(!isset($err)){
                ...
                if(!empty($_POST['id_produk'])){
                    ...
                    $sql="UPDATE produk SET nama='$_POST[nama]', merek='$_POST[merek]', harga='$_POST[harga]' photos='$_POST[photos]' WHERE id_produk='$_POST[id_produk]'";

                    }else{ 
                    $sql="UPDATE produk SET nama='$_POST[nama]', merek='$_POST[merek]', harga='$_POST[harga]' WHERE id_produk='$_POST[id_produk]'";
                    }
                }else{
                    //save
                    if(isset($_POST['photos'])){
                    $sql = "INSERT INTO produk (nama, merek, harga,photos) 
                    VALUES ('$_POST[nama]','$_POST[merek]','$_POST[harga]','$_POST[photos]')";
                    }else{
                    $sql = "INSERT INTO produk (nama, merek, harga) 
                    VALUES ('$_POST[nama]','$_POST[merek]','$_POST[harga]')";  
                    }
                }
